...
if [ -z "$CUSTOM_PACKAGES" ]; then
  ...
  cp -r /tmp/store-run-repo/run/x86/* /home/build/openwrt/extra-packages/
  #cp -r /tmp/kiddin9-run-repo/run/x86/* /home/build/openwrt/extra-packages/

  echo "✅ Run files copied to extra-packages:"
  ls -lh /home/build/openwrt/extra-packages/*.run
  # 解压并拷贝ipk到packages目录
  sh shell/prepare-packages.sh
  ls -lah /home/build/openwrt/packages/
fi
